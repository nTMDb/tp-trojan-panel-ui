export default {
  ...
  valid: {
    ...
    xrayFlow: 'لطفاً کنترل جریان را وارد کنید',
    ...
    uploadWebFileFormat: 'فرمت فایل فقط از .zip پشتیبانی می کند',
    uploadWebFileSize: 'حجم فایل نمی تواند بیش از 10 مگابایت باشد',
